...
WORKDIR /src
COPY ["THR.csproj", "."]
RUN dotnet restore "./THR.csproj"
COPY . .
WORKDIR "/src/."
RUN dotnet build "./THR.csproj" -c %BUILD_CONFIGURATION% -o /app/build

# This stage is used to publish the service project to be copied to the final stage
FROM build AS publish
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "./THR.csproj" -c %BUILD_CONFIGURATION% -o /app/publish /p:UseAppHost=true
